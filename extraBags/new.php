...
if(isset($_SESSION["user_name"]))
{
	...
	$arObjects = mysqli_query($con,"SELECT id,sap_code,ar_name,shop_name FROM ar_details WHERE sap_code IS NOT NULL AND shop_name IS NOT NULL ORDER BY ar_name ASC");	
