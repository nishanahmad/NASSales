...
$ar_detail = mysqli_query($con,"SELECT ar_id, special_target FROM ar_calculation_special_target WHERE  fromDate <= '$fromDate' AND toDate>='$toDate' ORDER BY ar_name") or die(mysqli_error($con));		 
